...
## Implementation Context: Shell Scripting
This project is implemented using the Bash Shell and standard Linux utilities (e.g., `bc`), as defined by the project’s technical scope.

- **Execution Environment**: Execution occurs within Unix-like terminal environments (Linux, macOS, Termux).
- **Scope Limitation**: This policy applies exclusively to the source code and academic materials contained within this repository and does not extend to the shell interpreter, operating system utilities, or platform-level security guarantees.
